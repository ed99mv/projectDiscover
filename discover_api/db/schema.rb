...
ActiveRecord::Schema[7.0].define(version: 2023_11_23_013516) do
  ...
  create_table "companies_photos", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "company_id"
    t.bigint "photo_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_companies_photos_on_company_id"
    t.index ["photo_id"], name: "index_companies_photos_on_photo_id"
  end
